...
import A1.A1a.LitTuple;
import A1.A1a.SymTuple;
import A1.A1a.Tuple;
...
public class Assembler_PassOne_V2{
	...
	static void pass1() throws Exception {
		BufferedReader input = new BufferedReader(new InputStreamReader(new FileInputStream("src/A1/A1a/input.txt")));
		out_pass1 = new PrintWriter(new FileWriter("src/A1/A1a/output_pass1.txt"), true);
		PrintWriter out_symtable = new PrintWriter(new FileWriter("src/A1/A1a/symtable.txt"), true);
		PrintWriter out_littable = new PrintWriter(new FileWriter("src/A1/A1a/littable.txt"), true);
		String s;
	...
	static void initializeTables() throws Exception {
		...
		String s,mnemonic;
		BufferedReader br;
		br = new BufferedReader(new InputStreamReader(new FileInputStream("src/A1/A1a/mot.txt")));
