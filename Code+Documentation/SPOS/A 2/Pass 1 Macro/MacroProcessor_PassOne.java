...
public class MacroProcessor_PassOne {
	...
	static void pass1() throws Exception {
		...
		BufferedReader input = new BufferedReader(new InputStreamReader(new FileInputStream("src/A2/A2a/input.txt")));
		PrintWriter out_pass1 = new PrintWriter(new FileWriter("src/A2/A2a/output_pass1.txt"), true);
		PrintWriter out_mnt = new PrintWriter(new FileWriter("src/A2/A2a/MNT.txt"), true);
		PrintWriter out_mdt = new PrintWriter(new FileWriter("src/A2/A2a/MDT.txt"), true);
